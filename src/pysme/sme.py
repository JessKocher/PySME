...
class ProfileNLTE(Collection):
    ...
    _fields = Collection._fields + [
        ...
        ("correction_construction", None, lowercase(oneof(None, "separate", "ratio")), this,
            "str or None: Construction mode for profile-NLTE correction factors; None keeps legacy/default behaviour"),
        ("summary", {}, this, this,
...
class SME_Structure(Parameters):
    ...
    _fields = Parameters._fields + [
        ...
        ("h_line_mode", None, lowercase(oneof(None, "off", "trace", "apply")), this,
            "str or None: Experimental hydrogen-line control mode; None keeps legacy/default behaviour"),
        ("h_line_form", None, lowercase(oneof(None, "wratio", "abs_only")), this,
            "str or None: Experimental hydrogen-line correction form; None keeps legacy/default behaviour"),
